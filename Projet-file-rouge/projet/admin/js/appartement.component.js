class Appartement extends React.Component {
    ...
    render() {
        ...
        return (
                <tr>
              <td scope="row">{this.props.appartement.numero_appartement}</td>
              <td scope="row">{this.props.appartement.prix_location}</td>
              <td>{this.props.appartement.etat_appartement}</td>
              <td></td>
              <td>
